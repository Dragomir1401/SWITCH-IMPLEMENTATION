...
def parse_bpdu(bpdu, root_bridge_id_p, root_path_cost_p, sender_bridge_id_p,
...
def main():
    ...
    while True:
        ...
        if dest_mac == "01:80:c2:00:00:00":
            root_bridge_id, root_path_cost = parse_bpdu(data, root_bridge_id,
                                                        root_path_cost, 0, interface,
